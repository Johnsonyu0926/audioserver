...
our %config = (
  ...
  build_infos => [ "./build.info", "crypto/build.info", "ssl/build.info", "apps/build.info", "test/build.info", "util/build.info", "tools/build.info", "fuzz/build.info", "crypto/objects/build.info", "crypto/md5/build.info", "crypto/sha/build.info", "crypto/hmac/build.info", "crypto/ripemd/build.info", "crypto/whrlpool/build.info", "crypto/des/build.info", "crypto/aes/build.info", "crypto/rc2/build.info", "crypto/seed/build.info", "crypto/sm4/build.info", "crypto/modes/build.info", "crypto/bn/build.info", "crypto/ec/build.info", "crypto/rsa/build.info", "crypto/dsa/build.info", "crypto/dh/build.info", "crypto/dso/build.info", "crypto/buffer/build.info", "crypto/bio/build.info", "crypto/stack/build.info", "crypto/lhash/build.info", "crypto/rand/build.info", "crypto/err/build.info", "crypto/evp/build.info", "crypto/asn1/build.info", "crypto/pem/build.info", "crypto/x509/build.info", "crypto/x509v3/build.info", "crypto/conf/build.info", "crypto/txt_db/build.info", "crypto/pkcs7/build.info", "crypto/pkcs12/build.info", "crypto/ui/build.info", "crypto/async/build.info", "crypto/kdf/build.info", "crypto/store/build.info", "test/ossl_shim/build.info" ],
  build_type => "release",
  builddir => ".",
  cflags => [  ],
  ...
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_ARIA", "OPENSSL_NO_BF", "OPENSSL_NO_BLAKE2", "OPENSSL_NO_CAMELLIA", "OPENSSL_NO_CAST", "OPENSSL_NO_CHACHA", "OPENSSL_NO_CMAC", "OPENSSL_NO_CMS", "OPENSSL_NO_COMP", "OPENSSL_NO_CT", "OPENSSL_NO_IDEA", "OPENSSL_NO_MD2", "OPENSSL_NO_MDC2", "OPENSSL_NO_POLY1305", "OPENSSL_NO_RC4", "OPENSSL_NO_RC5", "OPENSSL_NO_SIPHASH", "OPENSSL_NO_SM2", "OPENSSL_NO_SM3", "OPENSSL_NO_SRP", "OPENSSL_NO_TS" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASM", "OPENSSL_NO_ASYNC", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_ERR", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MSAN", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_DYNAMIC_ENGINE", "OPENSSL_NO_AFALGENG" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => "enable-shared no-afalgeng no-aria no-asan no-asm no-async no-bf no-blake2 no-camellia no-cast no-chacha no-cmac no-cms no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-ct no-devcryptoeng no-dso no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-engine no-err no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-idea no-md2 no-md4 no-mdc2 no-msan no-ocsp no-poly1305 no-rc4 no-rc5 no-sctp no-siphash no-sm2 no-sm3 no-srp no-ssl-trace no-ssl3 no-ssl3-method no-ts no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.26.1",
  perlargv => [ "linux-x86", "no-asm", "no-async", "shared", "no-md2", "no-md4", "no-mdc2", "no-poly1305", "no-blake2", "no-siphash", "no-sm3", "no-rc4", "no-rc5", "no-idea", "no-aria", "no-bf", "no-cast", "no-camellia", "no-chacha", "no-sm2", "no-dso", "no-engine", "no-err", "no-comp", "no-ocsp", "no-cms", "no-ts", "no-srp", "no-cmac", "no-ct" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  sdirs => [ "objects", "md5", "sha", "hmac", "ripemd", "whrlpool", "des", "aes", "rc2", "seed", "sm4", "modes", "bn", "ec", "rsa", "dsa", "dh", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "ui", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
