...
class MqttAudioStop {
public:
    MqttAudioStop(std::string clientId, std::string host, int port)
    ...
    [[nodiscard]] nlohmann::json handleAudioStopCommand(const nlohmann::json& command) {
        // 这里应该实现实际的音频停止逻辑
        // 为了示例，我们假设停止总是成功的
