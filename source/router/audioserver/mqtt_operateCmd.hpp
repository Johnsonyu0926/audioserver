...
public:
    MqttOperateCmd(std::string clientId, std::string host, int port)
    ...
    [[nodiscard]] nlohmann::json handleOperateCommand(const nlohmann::json& command) {
        // 这里应该实现实际的操作命令逻辑
        // 为了示例，我们假设操作总是成功的
