...
public:
    MqttLedShowSet(std::string clientId, std::string host, int port)
    ...
    [[nodiscard]] nlohmann::json handleLedShowSetCommand(const nlohmann::json& command) {
        // 这里应该实现实际的 LED 显示设置逻辑
        // 为了示例，我们假设设置总是成功的
