// Filename: multiband_gate_band_box.cpp
...
void set_end_label(MultibandGateBandBox* self, const float& value) {
  if (!GTK_IS_WIDGET(self) || !GTK_IS_LABEL(self->end_label)) {
    return;
  }
...
void set_envelope_label(MultibandGateBandBox* self, const float& value) {
  if (!GTK_IS_WIDGET(self) || !GTK_IS_LABEL(self->envelope_label)) {
    return;
  }
...
void set_curve_label(MultibandGateBandBox* self, const float& value) {
  if (!GTK_IS_WIDGET(self) || !GTK_IS_LABEL(self->curve_label)) {
    return;
  }
...
void set_gain_label(MultibandGateBandBox* self, const float& value) {
  if (!GTK_IS_WIDGET(self) || !GTK_IS_LABEL(self->gain_label)) {
    return;
  }
