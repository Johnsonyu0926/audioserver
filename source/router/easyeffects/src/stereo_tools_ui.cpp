...
struct _StereoToolsBox {
  ...
  GtkDropDown* mode;
  GtkSpinButton *balance_in, *balance_out, *slev, *sbal, *mlev, *mpan, *stereo_base, *delay, *sc_level, *stereo_phase, *dry, *wet;
...
void setup(StereoToolsBox* self, std::shared_ptr<StereoTools> stereo_tools, const std::string& schema_path) {
  ...
  g_settings_bind(self->settings, "balance-in", gtk_spin_button_get_adjustment(self->balance_in), "value", G_SETTINGS_BIND_DEFAULT);
  g_settings_bind(self->settings, "balance-out", gtk_spin_button_get_adjustment(self->balance_out), "value", G_SETTINGS_BIND_DEFAULT);
  ...
  g_settings_bind(self->settings, "stereo-base", gtk_spin_button_get_adjustment(self->stereo_base), "value", G_SETTINGS_BIND_DEFAULT);
  g_settings_bind(self->settings, "delay", gtk_spin_button_get_adjustment(self->delay), "value", G_SETTINGS_BIND_DEFAULT);
  g_settings_bind(self->settings, "sc-level", gtk_spin_button_get_adjustment(self->sc_level), "value", G_SETTINGS_BIND_DEFAULT);
  g_settings_bind(self->settings, "stereo-phase", gtk_spin_button_get_adjustment(self->stereo_phase), "value", G_SETTINGS_BIND_DEFAULT);
...
void stereo_tools_box_init(StereoToolsBox* self) {
  ...
  prepare_spinbuttons<"">(self->balance_in, self->balance_out, self->sc_level, self->sbal, self->mpan, self->stereo_base, self->stereo_phase);
