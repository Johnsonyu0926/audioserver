...
typedef struct lws_struct_args {
    ...
    struct lwsac *ac_chunks; /* temp ac used to collate unknown possibly huge strings before final allocation and copy */
