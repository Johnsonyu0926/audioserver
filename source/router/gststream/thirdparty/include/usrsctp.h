...
struct sctpstat {
	...
	uint32_t  sctps_sendsacks;           /* total output SACK          */
	...
	uint32_t  sctps_sendmultfastretrans; /* total FR's that happened more than once to same chunk */
	uint32_t  sctps_sendheartbeat;       /* total output HB chunks     */
	uint32_t  sctps_sendecne;            /* total output ECNE chunks   */
	uint32_t  sctps_sendauth;            /* total output AUTH chunks   */
	...
	uint32_t  sctps_pdrpcrupt;           /* P-drop, non-endhost, corrupt report */
	uint32_t  sctps_pdrpnedat;           /* P-drop, not enough data to confirm */
	uint32_t  sctps_pdrppdbrk;           /* P-drop, possibly due to broken path */
	uint32_t  sctps_pdrptsnnf;           /* P-drop, TSN not found */
	uint32_t  sctps_pdrpdnfnd;           /* P-drop, destination not found */
	uint32_t  sctps_pdrpdiwnp;           /* P-drop, data in wrong place */
	uint32_t  sctps_pdrpdizrw;           /* P-drop, data in zero window */
	uint32_t  sctps_pdrpbadd;            /* P-drop, bad destination */
	uint32_t  sctps_pdrpmark;            /* P-drop, marked for deletion */
	uint32_t  sctps_pdrp_spare;          /* formerly sctps_pdrpnocrc */
	uint32_t  sctps_pdrpswcrc;
	uint32_t  sctps_pdrphwcrc;
	...
	uint32_t  sctps_timoautoclose;       /* Number of auto close timers that fired */
	...
	/* others */
	uint32_t  sctps_spare[11];           /* Future ABI compat - remove int's from here when adding new */
};
