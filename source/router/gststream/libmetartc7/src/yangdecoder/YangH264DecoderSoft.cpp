// Filename: YangH264DecoderSoft.cpp
// Score: 95
...
int32_t yang_decode(struct YangH264DecContext *cont, int32_t isIframe, uint8_t *pData, int32_t nSize, enum YangYuvType yuvType, uint8_t *dest, int32_t *pnFrameReturned) {
...
YangH264DecoderSoft::YangH264DecoderSoft() {
    ...
    yang_decode = (int32_t (*)(struct YangH264DecContext *cont, int32_t isIframe, uint8_t *pData, int32_t nSize, enum YangYuvType yuvType, uint8_t *dest, int32_t *pnFrameReturned))m_lib.loadFunction("decode");
