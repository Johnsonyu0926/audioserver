// Filename: YangVideoDecoderHandles.cpp
// Score: 92
...
void YangVideoDecoderHandles::addVideoStream(uint8_t *ps, int32_t puid, int32_t pisAdd) {
    if (pisAdd) {
...
void YangVideoDecoderHandles::onAudioData(YangFrame* pframe) {
    // No implementation needed for audio data
}
