// Filename: YangAudioDecoderOpus.h
// Score: 94
...
private:
    ...
    int32_t (*yang_opus_decode)(OpusDecoder *st, const uint8_t *data, opus_int32 len, opus_int16 *pcm, int32_t frame_size, int32_t decode_fec);
