// Filename: YANGH264DECODERSOFT_H_
// Score: 94
...
private:
    ...
    void (*yang_init_H264DecCont)(struct YangH264DecContext *cont, uint8_t *headers, int32_t headerLen);
    int32_t (*yang_decode)(struct YangH264DecContext *cont, int32_t isIframe, uint8_t *pData, int32_t nSize, enum YangYuvType pyuvType, uint8_t *dest, int32_t *pnFrameReturned);
