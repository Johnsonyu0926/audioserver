...
void YangYuvConvert::loadLib() {
    ...
    yang_NV21ToRGB24 = (int32_t (*)(const uint8_t *src_y, int32_t src_stride_y,
            ...
            int32_t dst_stride_rgb24, int32_t width, int32_t height)) m_lib.loadFunction(
            "NV21ToRGB24");
    yang_ARGBToRGB24 = (int32_t (*)(const uint8_t *src_argb, int32_t src_stride_argb,
    ...
    yang_RGB24ToI420 = (int32_t (*)(const uint8_t *src_rgb24, int32_t src_stride_rgb24,
                    uint8_t *dst_y, int32_t dst_stride_y, uint8_t *dst_u,
                    int32_t dst_stride_u, uint8_t *dst_v, int32_t dst_stride_v,
    ...
    yang_ScalePlane = (void (*)(const uint8_t *src, int32_t src_stride, int32_t src_width,
...
int32_t YangYuvConvert::i420toyv12(uint8_t *src, uint8_t *dst, int32_t width, int32_t height) {
    yang_memcpy(dst, src, width * height); // Y component
    yang_memcpy(dst + width * height, src + width * height + width * height / 4, width * height / 4); // V component
    yang_memcpy(dst + width * height + width * height / 4, src + width * height, width * height / 4); // U component
    return 0;
}
...
int32_t YangYuvConvert::I420torgb24(uint8_t *src, uint8_t *dst, int32_t width, int32_t height) {
    return yang_I420ToRGB24((const uint8_t*) src, width,
            (const uint8_t*) (src + (width * height)), (width >> 1),
            (const uint8_t*) (src + (width * height) + (int) (width * height / 4)), (width >> 1), dst, width * 3,
            width, height);
}

int32_t YangYuvConvert::nv12torgb24(uint8_t *src, uint8_t *dst, int32_t width, int32_t height) {
    return yang_NV12ToRGB24((const uint8_t*) src, width,
            (const uint8_t*) (src + (width * height)), width, dst,
            width * 3, width, height);
}

int32_t YangYuvConvert::nv21torgb24(uint8_t *src, uint8_t *dst, int32_t width, int32_t height) {
    return yang_NV21ToRGB24((const uint8_t*) src, width,
            (const uint8_t*) (src + (width * height)), width, dst,
            width * 3, width, height);
}

int32_t YangYuvConvert::argbtorgb24(uint8_t *src, uint8_t *dst, int32_t width, int32_t height) {
    return yang_ARGBToRGB24((const uint8_t*) src, width * 4, dst,
            width * 3, width, height);
}

int32_t YangYuvConvert::rgb24toargb(uint8_t *src, uint8_t *dst, int32_t width, int32_t height) {
    return yang_RGB24ToARGB((const uint8_t*) src, width * 3, dst,
            width * 4, width, height);
}

int32_t YangYuvConvert::rgb24toI420(uint8_t *src_rgb24, uint8_t *dst, int32_t width, int32_t height) {
