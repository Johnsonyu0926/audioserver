// Filename: YangAudioEncoderMp3.h
// Score: 95
...
private:
    ...
    int32_t (*yang_lame_encode_buffer_interleaved)(lame_global_flags* gfp, int16_t pcm[], int32_t num_samples, uint8_t* mp3buf, int32_t mp3buf_size);
    int32_t (*yang_lame_close)(lame_global_flags *);
};

#endif /* __YangAudioMp3Encoder__ */
// By GST @Date