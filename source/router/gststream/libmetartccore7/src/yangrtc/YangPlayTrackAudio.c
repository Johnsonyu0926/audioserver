...
int32_t yang_playtrackAudio_check_send_nacks(YangRtcContext *context, YangPlayTrack *audiorecv) {
    int32_t err = Yang_Ok;
    uint32_t timeout_nacks = 0;
    if ((err = yang_playtrack_do_check_send_nacks(context, audiorecv, &timeout_nacks)) != Yang_Ok) {
